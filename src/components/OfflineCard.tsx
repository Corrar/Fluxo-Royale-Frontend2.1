    ...
    <FullScreenOverlay>
      <StyledWrapper>
        <div className="main_wrapper">
          ...
          {/* Título de aviso */}
          <h2 style={{ marginTop: '2rem', fontFamily: 'sans-serif', color: '#333', textAlign: 'center', fontWeight: 'bold' }}>
...
const StyledWrapper = styled.div`
  ...
  .screenM {
    ...
    position: relative;
    font-family: Montserrat, sans-serif;
    background: linear-gradient(to right, #002fc6 0%, #002bb2 14%, #3a3a3a 14%, #303030 28%, #ff0afe 28%, #f500f4 42%, #6c6c6c 42%, #626262 57%, #0affd9 57%, #00f5ce 71%, #3a3a3a 71%, #303030 85%, white 85%, #fafafa 100%);
    border-radius: 10px;
    border: 2px solid black;
    z-index: 99;
    display: flex;
  ...
  .screenM:before {
    top: 0;
    height: 68%;
    background: linear-gradient(to right, white 0%, #fafafa 14%, #ffe60a 14%, #f5dc00 28%, #0affd9 28%, #00f5ce 42%, #10ea00 42%, #0ed600 57%, #ff0afe 57%, #f500f4 71%, #ed0014 71%, #d90012 85%, #002fc6 85%, #002bb2 100%);
  }
  .screenM:after {
    bottom: 0;
    height: 21%;
    background: linear-gradient(to right, #006c6b 0%, #005857 16%, white 16%, #fafafa 33%, #001b75 33%, #001761 50%, #6c6c6c 50%, #626262 66%, #929292 66%, #888888 83%, #3a3a3a 83%, #303030 100%);
  }
  ...
  .b1::before {
    content: ""; margin-top: 1em; margin-left: 0.5em; transform: rotate(47deg); width: 0.1em; height: 0.4em; border-radius: 5px;
  }
  .b1::after {
    content: ""; margin-top: 0.9em; margin-left: 0.8em; transform: rotate(47deg); width: 0.1em; height: 0.55em; border-radius: 5px;
  }
  .b1 div {
    content: ""; margin-top: -0.1em; margin-left: 0.65em; transform: rotate(45deg); width: 0.15em; height: 1.5em;
  }
  .b2::before {
    content: ""; margin-top: 1.05em; margin-left: 0.8em; transform: rotate(-45deg); width: 0.15em; height: 0.4em; border-radius: 5px;
  }
  .b2::after {
    content: ""; margin-top: -0.1em; margin-left: 0.65em; transform: rotate(-45deg); width: 0.15em; height: 1.5em;
  }
